#Stuart- Need to add documentation for full credit on problem 8.
...
#Stuart- Very nice piece of code. Simple and direct.
...
'''QUESTION 5'''
#Stuart- Again a nice clean piece of code.
...
'''question 7'''
#Stuart- This isn't a function also try running it with the lists I've commented out below.
#Finally this isn't recursive.
...
#Stuart- The point of the question was to analyze the difference in the way that the 
#three implementations of the code ran. Need to add comments.
